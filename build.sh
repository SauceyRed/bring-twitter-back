...
./7zip/bash/7zzs a -tzip "$FIREFOX_ARCHIVE" .\icons .\bring-twitter-bird-back.js .\LICENSE .\manifest.json
echo "Archived $FIREFOX_ARCHIVE"

echo "Archiving $CHROMIUM_ARCHIVE"
cp manifest-v3.json manifest.json
./7zip/bash/7zzs a -tzip "$CHROMIUM_ARCHIVE" .\icons .\bring-twitter-bird-back.js .\LICENSE .\manifest.json
