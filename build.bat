...
.\7zip\cmd\7za.exe a -tzip %FIREFOX_ARCHIVE% .\icons .\bring-twitter-back.js .\LICENSE .\manifest.json
echo "Archived %FIREFOX_ARCHIVE%"

echo "Archiving %CHROMIUM_ARCHIVE%"
copy manifest-v3.json manifest.json /y
.\7zip\cmd\7za.exe a -tzip %CHROMIUM_ARCHIVE% .\icons .\bring-twitter-back.js .\LICENSE .\manifest.json
